...
class espController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('fsp.index', compact('newOrders', 'comrades', 'providers', 'activeOrders', 'balance', 'totalcomrades', 'rp', 'ratings', 'miniStatements', 'services'));
    }

    public function manualService()
    {
        return view('fsp.manual.service-book');
    }

    public function manualPhoneDist()
    {
        return view('fsp.manual.phone-dist');
    }

    public function manualComradeAddDel()
    {
        return view('fsp.manual.comrade-add-del');
    }

    public function manualComradeLogin()
    {
        return view('fsp.manual.comred-login');
    }
    ...
    {
        return view('fsp.manual.recharge');
    }

    public function manualCashout()
    {
        return view('fsp.manual.cashout');
    }

    public function manualSelfOrder()
    {
        return view('fsp.manual.self-order');
    }

    public function manualSPLogin()
    {
        return view('fsp.manual.sp-login');
    }
