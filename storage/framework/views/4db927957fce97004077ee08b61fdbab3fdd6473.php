            ...
            <div class="site-header-content-in">
                <div class="site-header-shown">
                    ...
                    <div class="dropdown dropdown-notification messages">
                        <a href="#" class="header-alarm dropdown-toggle active" id="dd-messages" data-toggle="dropdown"
                                ...
                                <div class="tab-pane active" id="tab-incoming" role="tabpanel">
                                    <div class="dropdown-menu-messages-list">
                                        ...
                                        <a href="#" class="mess-item">
                                            ...
                                            <span class="mess-item-txt">Morgan was bothering about something! Morgan was
                                                bothering about something.</span>
                                        </a>
                                        <a href="#" class="mess-item">
                                            <span class="avatar-preview avatar-preview-32"><img src="img/photo-64-2.jpg"
                                                    alt=""></span>
                    ...
                    <div class="dropdown user-menu">
                        <button class="dropdown-toggle" id="dd-user-menu" type="button" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">
                            <img src="<?php echo e(asset('dashboard/img/avatar-2-64.png')); ?>" alt="">
                        </button>
                ...
                <div class="site-header-collapsed">
                    <div class="site-header-collapsed-in">
                        ...
                        <a class="btn btn-nav btn-rounded btn-primary-outline" href="<?php echo e(route('esp-dashboard')); ?>">
                            Home
                        </a>
                        <a class="btn btn-nav btn-rounded" href="<?php echo e(route('esp-jobs')); ?>">
                            Jobs
                        </a>
                        <a class="btn btn-nav btn-rounded" href="<?php echo e(route('comrade')); ?>">
                            Comrade
                        </a>
                        <a class="btn btn-nav btn-rounded" href="#">
                            Services
                        </a>
                        <a class="btn btn-nav btn-rounded" href="#">
                            Income Statemen
