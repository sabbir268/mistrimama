        ...
        <div class="row">
            ...
            <div class="form-group col-md-12">
                ...
                <select class="form-control" id="disc" name="disc">
                    ...
                    <option value="<?php echo e($promo->percent); ?>"><?php echo e($promo->promocode); ?></option>
...
<script>
    ...
    $('.service_add_finish').click(function(){
       ...
       $.ajax({
                type: "GET",
                url: "<?php echo e(asset('')); ?>/admin/retrive_selected_service_bit/"+$servicec_id,
                dataType: 'json',
                success: function(data) {
                    for($i=0; $i < data.length; $i++){
                       // console.log(data[$i].name);
        ...
        $('#place_order_btn').click(function(e){
            ...
            $.ajax({
                url: "<?php echo e(route('admin.order.done')); ?>",
                type: 'post',
                data: $data,
                dataType: 'html',
                success: function(response) {
