                        ...
                        <tbody>
                            ...
                            <tr class="bg-mm-light">
                                ...
                                <td colspan="2" class="text-right">
                                    <strong><?php echo e($sumOrder->first()->total_price + $activeOrders->extra_charge); ?></strong>
                                </td>
                                <td colspan="" class="text-left"></td>
                            </tr>
                            <?php if(promocheck(auth()->user()->id , $sumOrder->first()->total_price) > 0 ): ?>
                            <tr class="bg-mm-light">
                                <td colspan="2" class="text-right">Discount (promo)</td>
                                <td colspan="2" class="text-right">
                                    <?php echo e(promocheck(auth()->user()->id , $sumOrder->first()->total_price)); ?></td>
                                <td colspan="" class="text-left"></td>
                            </tr>
                            <?php endif; ?>
                            <tr class="bg-mm-light">
                                ...
                                <td colspan="2" class="text-right">
                                    <strong><?php echo e((($sumOrder->first()->total_price + $activeOrders->extra_charge) - promocheck(auth()->user()->id , $sumOrder->first()->total_price))); ?></strong>
                                </td>
                                <td colspan="" class="text-left"></td>
                            </tr>
                        </tbody>
