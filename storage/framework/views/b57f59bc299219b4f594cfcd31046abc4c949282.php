            ...
            <table class="table table-bordered table-striped table-condensed flip-content">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($actorder->order ? $actorder->order->order_date : ''); ?>/<?php echo e($actorder->order ? $actorder->order->order_time : ''); ?></td>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label>Client:</label>
                                    <input type="hidden" class="form-control" name="user_id" value="<?php echo e($order->user ? $order->user->id : '-'); ?>"  >
                                    <input type="text" class="form-control" name="user_name" value="<?php echo e($order->user ? $order->user->name : '-'); ?>" readonly >
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="card-header col-md-6">
                                            ...
                                            Name:<strong><?php echo e($actOrder->provider ? $actOrder->provider->name : ''); ?></strong><br> Phone:
                                            ...
                                            Name:<strong><?php echo e($actOrder->comrade ? $actOrder->comrade->c_name : ''); ?></strong><br> Phone:
