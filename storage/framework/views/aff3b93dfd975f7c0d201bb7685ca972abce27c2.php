...
<!--            <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
            ...
            <li><a href="<?php echo e(route('admin.order.create')); ?>" style="padding: 0px;"> <button style="margin: 8px;" class="btn btn-primary"> <i class="fa fa-plus"></i> Place New Order</button> </a></li>
