        ...
        <div class="portlet box green">
            ...
            <div class="portlet-body flip-scroll">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <form action="<?php echo e(route('admin.sp.search')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                ...
                <table class="table table-bordered table-striped table-condensed flip-content">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($p->comrads ? count($p->comrads) : 0); ?></td>
                            <td>
                                <a href="<?php echo e(route('service-provider.show',$p->id)); ?>" class="btn btn-info">Profile</a>
                                <?php if(checkRole(auth()->user()->id, 'admin')): ?>
