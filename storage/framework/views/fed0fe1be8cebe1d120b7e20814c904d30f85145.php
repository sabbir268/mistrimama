                ...
                <div class="site-header-shown">
                    ...
                    <div class="dropdown user-menu">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dd-user-menu">
                            <a class="dropdown-item" href="<?php echo e(route('user.edit-info')); ?>"><span class="font-icon glyphicon glyphicon-user"></span>Profile</a>
                            <a class="dropdown-item" href="<?php echo e(route('user.edit-info')); ?>"><span class="font-icon glyphicon glyphicon-cog"></span>Settings</a>
