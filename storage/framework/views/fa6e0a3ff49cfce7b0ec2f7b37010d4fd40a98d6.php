                ...
                <form action="<?php echo e(route('promotion-add')); ?>"  method="post">
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="">Enter The Promocode</span>
                        </div>
                        <input type="text" placeholder="A4772" name="promocode" class="form-control">
                        <input type="submit" class="btn btn-success rounded-0" value="Check">
                        </div>
                </form>
            </section>
        </div>
