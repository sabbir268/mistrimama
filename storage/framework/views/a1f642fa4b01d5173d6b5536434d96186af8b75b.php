            ...
            <div class="portlet-body flip-scroll">
                ...
                <table  class="table table-bordered table-striped table-condensed flip-content">
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($p->status == 2): ?>
                                    <a href="<?php echo e(url('activate/provider/'.$p->id)); ?>" data-toggle="tooltip" data-title="Click To Activate" class="btn btn-success">Activate </a>
                                <?php else: ?>
                                    <a href="<?php echo e(url('deactivate/provider/'.$p->id)); ?>" data-toggle="tooltip" data-title="Click To De-Activate" class="btn btn-danger">De-Activate </a>
                                <?php endif; ?>
                            </td>
