	...
	<div class="col-md-11 ml-5 bg-white">
		...
		<div class="row">
			<div class="col-md-6 text-center">
				<img class="rounded mx-auto d-block" style="width:65%" src="<?php echo e(asset('images/manuals/sp_login/1.png')); ?>"
					alt="">
			</div>
		...
		<div class="row">
			<div class="col-md-6 text-center">
				<img class="rounded mx-auto d-block" style="width:65%" src="<?php echo e(asset('images/manuals/sp_login/2.png')); ?>"
					alt="">
			</div>
			<div class="col-md-6 text-center d-flex">
				<h4 class="m-auto">
		...
		<div class="row">
			<div class="col-md-6 text-center">
				<img class="rounded mx-auto d-block" style="width:65%" src="<?php echo e(asset('images/manuals/sp_login/3.png')); ?>"
					alt="">
			</div>
			<div class="col-md-6 text-center d-flex">
				<h4 class="m-auto">
		...
		<div class="row">
			<div class="col-md-6 text-center">
				<img class="rounded mx-auto d-block" style="width:65%" src="<?php echo e(asset('images/manuals/sp_login/4.png')); ?>"
					alt="">
			</div>
			<div class="col-md-6 text-center d-flex">
				<h4 class="m-auto">
		...
		<div class="row">
			<div class="col-md-6 text-center">
				<img class="rounded mx-auto d-block" style="width:65%" src="<?php echo e(asset('images/manuals/sp_login/5.png')); ?>"
					alt="">
			</div>
			<div class="col-md-6 text-center d-flex">
				<h4 class="m-auto">
