...
<head>
    ...
    <title>Mistri Mama | Dashboard</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="<?php echo e(url('/panel')); ?>" class="logo">
            ...
            <span class="logo-mini"><b>M</b>Mama</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>Mistri </b>Mama</span>
        </a>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="<?php echo e(asset('/a.png')); ?>" class="img-circle" alt="User Image">
                </div>
                <div class="pull-left info">
                    ...
                    <?php if(Auth::user()->hasRole('admin')): ?>
                        ...
                        Service Provider
                        <?php elseif(Auth::user()->hasRole('referar')): ?>
                            Referrar
<?php endif; ?>                    </a>
                </div>
            </div>
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <?php if(Auth::user()->hasRole('admin')): ?>
                <li>
                    <a href="<?php echo e(url('/panel/category')); ?>">
                ...
                <li>
                    <a href="<?php echo e(url('/panel/provider')); ?>">
                        <i class="fa fa-th"></i> <span>Providers</span>
                        <span class="pull-right-container">
              <small class="label pull-right bg-green">4 new</small>
            </span>
                    </a>
                </li>
                <?php endif; ?>
