            ...
            <header class="box-typical-header panel-heading">
                <div class="row">
                    <div class="col-md-6 float">
                        <button type="button" class="btn btn-sm  btn-inline btn-success" data-toggle="modal" data-target="#addComradeMdl">Add New</button>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="box-typical-body panel-body ">
                <table class="tbl-typical">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><img style="height:50;width:50" src="<?php echo e(asset('uploads/SP')); ?>/<?php echo e($comrade->c_pic); ?>" class="rounded-circle"
                                    alt="some"></td>
...
<!-- Modal -->
<div class="modal fade " id="addComradeMdl" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-1">
                                ...
                                <div class="">
                                    <input name="c_name" type="text" class="form-control" placeholder="Ex: Karim Hossain" required>
                                </div>
                            </div>
                            <div class="form-group mb-1">
                                <label class="control-label" for="c_phone_no">Phone:</label>
                                <div class="">
                                    <input type="tel" name="c_phone_no" pattern="+[0-9]{14}" value="+880" class="form-control" placeholder="Ex: 01775280411"
                                        required>
                                </div>
                            </div>
                            <div class="form-group mb-1">
                                ...
                                <div class="">
                                    <input type="tel" name="c_alt_phone_no" pattern="+[0-9]{14}" value="+880" class="form-control" placeholder="Ex: 01775280411"
                                        required>
                                </div>
                            </div>
                            <div class="form-group mb-1">
                                ...
                                <div class="">
                                    <input type="email" name="email" class="form-control" placeholder="Ex: amaila@gmail.com" required>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-1">
                                ...
                                <div class="">
                                    <input type="text" name="c_nid" class="form-control" minlength="13" maxlength="16" placeholder="Ex: 1992324234234" required>
                                </div>
                            </div>
                            <div class="form-group mb-1">
                                ...
                                <div class="input-group mb-3">
                                    <div class="custom-file">
                                        <input type="file" name="c_pic" class="custom-file-input" id="inputGroupFile02" required>
                            ...
                            <div class="form-group mb-1">
                                ...
                                <div class="input-group mb-3">
                                    <div class="custom-file">
                                        <input type="file" name="c_nic_front" class="custom-file-input" id="inputGroupFile02" required>
                                        <label class="custom-file-label" for="inputGroupFile02">Choose file</label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group mb-1">
                                ...
                                <div class="input-group mb-3">
                                    <div class="custom-file">
                                        <input type="file" name="c_nic_back" class="custom-file-input" id="inputGroupFile02" required>
                                        <label class="custom-file-label" for="inputGroupFile02">Choose file</label>
                                    </div>
                                </div>
                            </div>
