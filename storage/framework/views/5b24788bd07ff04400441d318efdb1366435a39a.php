    ...
    <div class="row">
                ...
                <div class="col-xs-6 offset-xs-2 col-md-6 offset-md-2 pt-5 pb-4 mt-1 mb-2">
                    <div class="uploading-container-left text-center">
                        ...
                        background-position: center;">
                            <form action="<?php echo e(route('esp-photo-update')); ?>" method="POST" id="profile-upload">
                                <?php echo csrf_field(); ?>
                                <div class="profile-image-upload">
                                    ...
                                    <span class="btn btn-rounded btn-file bg-mm border-0">
                                        ...
                                        <input type="text" id="profile-photo" name="photo" class="btn border-0 bg-mm "
                                            onclick="openKCFinderProfilePic(this)" style="width:70%"
                                            value="<?php echo e($users->photo != null ? $users->photo : 'Choose Image'); ?>"
                                            name="photo" readonly>
                                    </span>
                                </div>
        ...
        <div class="col-md-7">
            <section class="box-typical-section">
                ...
                <?php echo Form::model($users, ['method' => 'POST','route' => ['esp-profile-update'] ]); ?>
