...
<section class="box-typical steps-icon-block">
                ...
                <div class="card-body ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-center pt-2">
                            ...
                            <span style="cursor :pointer" class="bg-success pl-3 pr-3 pt-1 pb-1 text-white ml-3 rounded addRemove" data-id="<?php echo e($data->id); ?>" id="addRemove<?php echo e($data->id); ?>">ADD</span>
                        </div>
                    </div>
    ...
    <button type="button" id="dateTime" class="btn btn-rounded float-right"> <a href="#"> Next →</a></button>
