    ...
    <div class="col-md-12 ">
        <div class="portlet box green ">
            ...
            <div class="portlet-body form">
                <?php echo Form::model($model, ['method' => 'PATCH','files' => true , 'route' => ['service-category.update', $model->id], 'class'=>'form-horizontal']); ?>
                    ...
                    <div class="form-group">        
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <?php echo Form::text('main_image', null, array('placeholder' => 'main_image','class' => 'form-control',"onclick" => "openKCFinder(this)")); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <?php echo Form::text('icon_image', null, array('placeholder' => 'icon_image','class' => 'form-control',"onclick" => "openKCFinder(this)")); ?>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label">hover_image</label>
                                <div class="col-md-9">
                                    <?php echo Form::text('image_hover', null, array('placeholder' => 'image_hover','class' => 'form-control',"onclick" => "openKCFinder(this)")); ?>

                                    <span class="bg-danger"><?= $errors->first('image_hover'); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <?php echo Form::textarea('description', null, array('placeholder' => 'Description','id'=>'description','class' => 'form-control')); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <?php echo Form::textarea('unique_benefits', null, array('placeholder' => 'unique_benefits','id'=>'unique_benefits','class' => 'form-control')); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <?php echo Form::textarea('service_category', null, array('placeholder' => 'service_category','id'=>'service_category','class' => 'form-control')); ?>
