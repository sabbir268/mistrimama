...
<head>
    ...
    <title>Mistri mama: User Dashboard || Promotion</title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <div id="main-content">
                    ...
                    <div class="row">
                        <h3 class="text-left" style="padding-left: 14px;"> Promotion </h3>
                       
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="card">

                                <h3 class="text-center"> <i class="ti ti-tag" style="font-size: 100px;"></i>
                                    <i class="ti ti-star" style="font-size: 100px;"></i></h3>
                                <p class="lead text-center">Nothing exciting here yet </p>
                                     
                                 <form>
                                   <div class="form-group col-sm-8">
                                       <input type="text" class="form-control " name="text" placeholder="promo code" />       
                                   </div>   
                                   <div class="col-sm-4">  
                                        <button type="submit" class="btn btn-info btn-md btn-flat"> Add promo </button>
                                   </div> 
                                </form>
