...
<head>
    ...
    <link href="http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700&subset=all" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('admin/global/plugins/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('admin/global/plugins/simple-line-icons/simple-line-icons.min.css') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('admin/global/plugins/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('admin/global/plugins/bootstrap-switch/css/bootstrap-switch.min.css') }}" rel="stylesheet"
        type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->
    <!-- BEGIN THEME GLOBAL STYLES -->
    <link href="{{ asset('admin/global/css/components.min.css') }}" rel="stylesheet" id="style_components"
        type="text/css" />
...
<body class=" login">
    ...
    <div class="content">
        <div class="col-md-12">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" method="POST" action="{{route('user.do-login')}}">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off"
                        placeholder="Phone Number" name="phone_no" value="{{ old('phone_no') }}" required autofocus />
                    @if ($errors->has('phone_no'))
                    <span class="required">{{ $errors->first('phone_no') }}</span>
                    @endif
                </div>
                <div class="form-group">
    ...
    <div class="copyright"> {{ date("Y",strtotime('now')) }} ©MistriMama</div>
