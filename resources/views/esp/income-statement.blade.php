    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-xl-6">
                <section class="widget widget-simple-sm">
                    <div class="widget-simple-sm-statistic">
                        <div class="number">টাকা {{$totalOrderValueSelf}}/-</div>
                        <a class="caption color-purple btn-link text-mm" href="{{route('job.all',['self','2019-01-01',date("Y-m-d")])}}">View Details</a>
                    </div>
                    <div class="widget-simple-sm-bottom statistic">
            ...
            <div class="col-xl-6">
                <section class="widget widget-simple-sm">
                    <div class="widget-simple-sm-statistic">
                        <div class="number">টাকা {{$totalOrderValueMm}}/-</div>
                            <a class="caption color-purple btn-link text-mm" href="{{route('job.all',['others','2019-01-01',date("Y-m-d")])}}">View Details</a>
                    </div>
                    <div class="widget-simple-sm-bottom statistic">
