<nav class="side-menu">
    <ul class="side-menu-list">
        <li class="grey"><a href="{{route('job-history-esp')}}">
                <span class="glyphicon glyphicon-th"></span>
                <span class="lbl">পূর্বের কাজ</span></a></li>
        <li class="grey"><a href="{{route('esp.behalf.order')}}">
                <span class="glyphicon glyphicon-th"></span>
        ...
        <li class="grey"><a href="{{route('recharge')}}">
            <span class="glyphicon glyphicon-th"></span>
            <span
                    class="lbl">রিচার্জ করুন</span></a></li>

        <li class="grey"><a href="{{route('esp-faq')}}">
                <span class="glyphicon glyphicon-th"></span>
