...
<section class="box-typical steps-icon-block">
    ...
    <form action="{{route('store-date-time')}}" method="post">
  {{csrf_field()}}
 <!-- <div class="row">
  ...
  <div class="col-xl-6 offset-md-3 ">
        ...
        <div class="form-group row">
            ...
            <div class="col-xl-8">
                <div class="input-group">
                    {{-- <input type="text" name="time" id="booking_time" class="form-control clockpicker" placeholder="Chose Date" required> --}}
    ...
    <button type="button" class="btn btn-rounded btn-grey float-left"> <a href="{{route('show-booking-services')}}">← Back</a></button>
