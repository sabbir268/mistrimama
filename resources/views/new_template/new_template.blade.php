...
<section>
    <div id="call-for-order-mobile" class="call-for-order-mobile">
        <a href="tel: +8809610222111">
            <img style="max-width" src="{{asset('images/call.png')}}" alt="">
        </a>
    </div>
                    ...
                    <div class="card-container col-md-4 col-sm-4 col-xs-6">
                        ...
                        <div class="sf-categories-girds  ">
                            ...
                            <div class="sf-categories-content text-center">
                                ...
                                <div class="icons">
                                    <img class="hover_icon_img" style="width:120px" src="{{ $item->image_hover }}"
                                        alt="ICON">
...
<div id="about" class="text-center providers-follow">
    <div class="container">
        <div class="w-t-element">
            ...
            <div class="sf-follow-text" style="padding-top: 20px;text-align: justify;">{!!
                $model->pageAttribute->home_about_us_description !!}</div>
        </div>
    </div>
