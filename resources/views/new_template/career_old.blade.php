        ...
        <div class="row">
            <div class="col-md-7 col-lg-7 message" style="margin: 0px auto;">
                ...
                <h4 class="heading-title text-center" style="text-align:justify;text-align:center">Check Opportunity &amp; Apply</h4>
                 {!! Form::open(array('url' => 'career-store', 'method'=>'POST','files' => 'true','enctype'=>'multipart/form-data')) !!}
                    <div class="row">
                        
                        <div class="col-sm-6 FormOne">
                            <h4 style="text-transform: uppercase;">Register Here :</h4>
                            {!! Form::text('first_name', null, array('placeholder' => 'First Name','required'=>"required",'class' => 'form-wrap')) !!}
                            <span  class="error"><?= $errors->first('first_name'); ?></span>
                        </div>
                        
                        <div class="col-sm-6 FormOne">
                            <h4 style="text-transform: uppercase;">Your Details :</h4>
                            {!! Form::text('last_name', null, array('placeholder' => 'Last Name','required'=>"required",'class' => 'form-wrap')) !!}
                        ...
                        <div class="col-sm-6 FormOne">
                            ...
                            {!! Form::email('email', null, array('placeholder' => 'Email','required'=>"required",'class' => 'form-wrap')) !!}
                            <span  class="error"><?= $errors->first('email'); ?></span>
                         </div>

                        <div class="col-sm-6 FormOne">
                            {!! Form::text('phone_number', null, array('placeholder' => 'Phone Number','Last Name'=>"required",'class' => 'form-wrap')) !!}
                            <span  class="error"><?= $errors->first('phone_number'); ?></span>
                             
                        </div>

                        <div class="col-sm-6 FormOne">
                            {!! Form::text('con-password', null, array('placeholder' => 'Years of Experience','phone_number'=>"required",'class' => 'form-wrap')) !!}
                        ...
                        <div class="col-sm-6 FormOne">
                            {!! Form::text('con-password', null, array('placeholder' => 'Salary Expectation','phone_number'=>"required",'class' => 'form-wrap')) !!}
                            <span  class="error"><?= $errors->first('year_of_exp'); ?></span>
                        </div>
                        
                        <div class="col-sm-6 FormOne">
                            {!! Form::file('Cv', null, array('placeholder' => '','phone_number'=>"required",'class' => 'form-wrap')) !!}
                            <span  class="error"><?= $errors->first('year_of_exp'); ?></span>
                        </div>
                        ...
                        <!--This is Start of the Checkbox code -->
                            <div class="col-sm-6 checkOne" style="background-color: #0d306b;max-width: 43%;margin-left: 24px;margin-bottom: 10px;padding: 15px;padding-top: 22px;">
                                {!! Form::checkbox('Cv', null, array('placeholder' => '','phone_number'=>"required",'class' => 'form-wrap')) !!}
                                <span  class="error"><?= $errors->first('year_of_exp'); ?></span>
                        ...
                        <div class="col-sm-12">
                            {!! Form::textarea('con-password', null, array('placeholder' => 'Tell us why you want to work for WebAble','phone_number'=>"required",'class' => 'form-wrap')) !!}
                            <span  class="error"><?= $errors->first('year_of_exp'); ?></span>
                        </div>
                        
                        
                        <div class="col-sm-12">
                            {!! Form::text('con-password', null, array('placeholder' => 'Website/Portfolio/Linkedin','phone_number'=>"required",'class' => 'form-wrap')) !!}
                            <span  class="error"><?= $errors->first('year_of_exp'); ?></span>
                        </div>
