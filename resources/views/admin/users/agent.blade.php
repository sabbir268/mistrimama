    ...
    <div class="col-md-12">
        <div class="portlet box green">
            ...
            <div class="portlet-body flip-scroll">
                <div class="row">
                    <div class="col-md-12">
                        <button style="margin: 10px;" class="btn btn-primary pull-right">Total: {{$usersCount}}</button>
                        <button style="margin: 10px;" class="btn btn-primary pull-right"><a
                                href="{{route('users.agent.export')}}" target="_blank" style="color:#fff">Export to
                                CSV</a></button>
                    </div>
                </div>
