                ...
                <div class="col-md-8">
                    <section class="box-typical-section">
                        <div class="col-md-12 p-0 pb-2">
                            <div class="row">
                                <div class="col-md-6">
                                    <button class="btn btn-mm btn-sm col-md-12">Add New Service</button>
                                </div>
                                <div class="col-md-6">
                            ...
                            <table class="table table-striped text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><button 
                                                class="btn btn-rounded btn-sm btn-success-outline finsih_sub"><i
                        ...
                        <div class="col-md-12 p-0 pb-2">
                            ...
                            <form action="<?php echo e(route('service-update-sts')); ?>" method="post">
                                    ...
                                    <button type="submit" class="btn  btn-primary" style="width:100%">Start Servicing</button> <?php break; ?>
                                    <?php case (2): ?>
                                    ...
                                    <ul class="list-group mb-2">
                                        <li class="list-group-item p-0 m-0 border-0 ">User Paid: <span class="invisible">1232</span> <strong><?php echo e((($sumOrder->total_price + $sumOrder->extra_price) - $sumOrder->disc)); ?> BDT</strong></li>
                                        <li class="list-group-item p-0 m-0 border-0 "> User Discount:  <strong><?php echo e($sumOrder->disc); ?> BDT</strong></li>
                                        <li class="list-group-item p-0 m-0"></li>
                                        <li class="list-group-item p-0 m-0 border-0 "> You Earn: <span class="invisible">123s2</span> <strong><?php echo e((($sumOrder->total_price + $sumOrder->extra_price) )); ?> BDT</strong></li>
                                    </ul>                                    
                                    <input type="text" value="5" name="status" hidden>
                                    <input type="text" value="<?php echo e((($sumOrder->total_price + $sumOrder->extra_price) - $sumOrder->disc)); ?>" name="amount" hidden>
                                    ...
                                    <button type="submit" class="btn  btn-success" style="width:100%">Accept Payment</button>
                                    <?php break; ?>
                                    <?php default: ?>
