...
<section class="box-typical steps-icon-block">
    ...
    <section class="box-typical-section bg-white rounde ">
            ...
            <form action="<?php echo e(route('servicec_store')); ?>" class="step1Form"
                method="post" data-category-id="<?php echo e($data->id); ?>" data-base-price="<?php echo e($data->price); ?>"
                        ...
                        <div class="row">
                            ...
                            <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                         <button type="button" class="btn btn-sm btn-danger mr-0" id="decrease-<?php echo e($data->id); ?>" onclick="decreaseQuantity(this, <?php echo e($data->id); ?>)" data-base-price="<?php echo e($data->price); ?>" data-additional-price="<?php echo e($data->additional_price); ?>"><i class="fa fa-minus"></i></button>
                                    </div>
                                    <input type="text" value="1" class="btn btn-sm bg-white rounded-0 text-center mr-0 ml-0" name="qty" placeholder="Qty" id="increment<?php echo e($data->id); ?>">
                                    <div class="input-group-append">
                                            <button type="button" class="btn btn-success ml-0" id="increase-<?php echo e($data->id); ?>" onclick="increaseQuantity(this, <?php echo e($data->id); ?>)" data-base-price="<?php echo e($data->price); ?>" data-additional-price="<?php echo e($data->additional_price); ?>"><i class="fa fa-plus"></i></button>
                                    </div>
                            </div>
                        </div>
                        <div class="col-md-4">
