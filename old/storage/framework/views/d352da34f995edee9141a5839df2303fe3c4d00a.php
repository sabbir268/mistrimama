                ...
                <div class="tbl-row">
                    <div class="tbl-cell pb-0">
                        ...
                        <a href="#" data-toggle="modal" data-target="<?php if($balance < 1000): ?> #amount_withdraw <?php else: ?> # <?php endif; ?>"
                            style="width:100%"
                            class="btn btn-sm btn-inline btn-mm-outline mt-2 <?php if($balance < 1000): ?> disabled <?php endif; ?> ">Ask
                            for Cash out</a>
                    </div>
                    <div class="tbl-cell pb-0">
                        <div class="tbl tbl-item">
                        ...
                        <a href="#" style="width:100%"
                            class="btn btn-sm btn-inline btn-mm-outline mt-2 <?php if($rp < 4000): ?> disabled <?php endif; ?> ">Convert
                            to
                            Cash</a>
                    </div>
                    <div class="tbl-cell pb-0">
