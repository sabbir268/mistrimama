...
<div class="modal fade" id="myModal-<?php echo e($order->id); ?>" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo e(route('provider.allowcate')); ?>">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="card-header col-md-6">
                                            ...
                                            Name:<strong><?php echo e($actOrder->provider->name); ?></strong><br> Phone:
                                            <strong><?php echo e($actOrder->provider->phone_no); ?></strong>
                                            <br>
