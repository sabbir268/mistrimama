<nav class="side-menu">
    <ul class="side-menu-list">
        <li class="grey with-sub">
            ...
            <ul>
                <li><a href="<?php echo e(route('book-self')); ?>"><span class="lbl">Order for self </span></a></li>
                <li><a href="<?php echo e(route('book-others')); ?>"><span class="lbl">Order for other</span></a></li>
            </ul>
        </li>
        <li class="grey">
