                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group mb-1">
                                ...
                                <div class="input-group mb-3">
                                        <label class="input-group-text rounded-0" for="inputGroupFile02">Choose file</label>
                                        <input type="text" name="c_pic" class="form-control" id="inputGroupFile02"
                                            onclick="openKCFinder(this)" required placeholder="Chose file">
                                </div>
                            </div>
                            <div class="form-group mb-1">
                                ...
                                <div class="input-group mb-3">
                                        <label class="input-group-text rounded-0" for="inputGroupFile02">Choose file</label>
                                        <input type="text" name="c_nic_front" class="form-control" id="inputGroupFile02"
                                            onclick="openKCFinder(this)" required placeholder="Chose file">
                                </div>
                            </div>
                            <div class="form-group mb-1">
                                ...
                                <div class="input-group mb-3">
                                        <label class="input-group-text rounded-0" for="inputGroupFile02">Choose file</label>
                                        <input type="text" name="c_nic_back" class="form-control" id="inputGroupFile02"
                                            onclick="openKCFinder(this)" required placeholder="Chose file">
                                </div>
