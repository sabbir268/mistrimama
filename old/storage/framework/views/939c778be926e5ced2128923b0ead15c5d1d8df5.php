            ...
            <div id="qtyCont" class="col-md-5" style="display:block">
                <div class="input-group input-group-sm">
                    <span style="cursor :pointer"
                        class="input-group-text pl-3 pr-3 pt-1 pb-0 text-white rounded-0 mr-0 decrease"
                        data-id="<?php echo e($SubType->sub_cat_details_id); ?>" data-service="<?php echo e($service_id); ?>">
                        <i class="fa fa-minus"></i></span>

                    <span class="mr-0 ">
                        <input type="text" value="<?php echo e($SubType->quantity); ?>" style="width:35px" class="pb-1 text-center " name="qty"
                            placeholder="Qty" id="qty<?php echo e($SubType->sub_cat_details_id); ?>" data-service="<?php echo e($service_id); ?>">
                    </span>

                    <span style="cursor :pointer"
                        class="input-group-text pl-3 pr-3 pt-1 pb-0 text-white mr-0 rounded-0 increase"
