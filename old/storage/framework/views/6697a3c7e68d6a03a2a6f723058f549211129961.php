    ...
    <div class="tabs-section-nav tabs-section-nav-icons">
        <div class="tbl">
            <ul class="nav" role="tablist">
                <li class="nav-item">
                    <a class="nav-link text-mm" href="#tabs-1-tab-1" role="tab" data-toggle="tab"
                        aria-selected="true">
                ...
                <li class="nav-item text-center">
                    <a class="nav-link active show text-mm" href="#tabs-1-tab-2" role="tab" data-toggle="tab" aria-selected="false">
                        <span class="nav-link-in text-mm">
                            <span class="font-icon font-icon-player-subtitres text-mm"></span>
                            <span class="invisible">Request fr</span>Ongoing & Schedule Order <span class="invisible">Request fr</span>
                        </span>
                    </a>
                </li>
            </ul>
