                                            ...
                                            <tr>
                                                ...
                                                <table cellpadding="0" cellspacing="0" style="height: 3px;" width="100%">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td style="width:194px; padding-bottom:17px; vertical-align:middle;"> MESSAGE:</td>
                                                            <td style="padding-bottom:17px; vertical-align:middle; line-height: 1.4"><?php echo  ($text) ?></td>
                                                        </tr>

                                                        <tr>
                                                            <td style="width:194px; padding-bottom:17px; vertical-align:middle;"> Company:</td>
                                                            <td style="padding-bottom:17px; vertical-align:middle; line-height: 1.4"><?php echo ($company) ?></td>
                                                        </tr>

                                                        <tr>
                                                            <td style="width:194px; padding-bottom:17px; vertical-align:middle;">Service:</td>
                                                            <td style="padding-bottom:17px; vertical-align:middle; line-height: 1.4"><?php echo ($getService) ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                </td>
